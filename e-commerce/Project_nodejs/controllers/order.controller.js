...
const deleteOrder = async (req, res) => {
    try {
      ...
      logError("deleteOrder", error, res);
    }
  };
  ...
  const updateOrder = async (req, res) => {
    const transaction = await sequelize.transaction();
    try{
      const {id, customerId, status, orderAmount, orderItems} = req.body;
      ...
      res.status(200).json({
        ...
        logError("updateOrder", error, res);
    }
  }

module.exports = { getOrder, createOrder, deleteOrder, updateOrder };